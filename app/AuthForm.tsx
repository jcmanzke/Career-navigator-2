...
export default function AuthForm({ mode }: { mode: AuthMode }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto w-full flex flex-col gap-3 max-w-xs text-left">
      <label className="text-small text-neutrals-600 mt-3 mb-1 block">eMail</label>
      <input
        type="email"
        placeholder="Email"
        value={email}
      ...
      <label className="text-small text-neutrals-600 mt-4 mb-1 block">Pin</label>
