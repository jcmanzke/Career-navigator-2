...
export default function AuthForm({ mode }: { mode: AuthMode }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto w-full max-w-xs text-left flex flex-col gap-4">
      <div className="space-y-1">
        <label className="text-small text-neutrals-600 block">eMail</label>
        <input
          type="email"
          placeholder="Email"
          value={email}
          ...
          required
          className="h-12 px-4 rounded-2xl border border-accent-700 w-full"
        />
      </div>

      <div className="space-y-1">
        <label className="text-small text-neutrals-600 block">Pin</label>
