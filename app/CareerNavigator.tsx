  ...
  return (
    <div className="space-y-4">
      <section className={cls(cardCls, "p-4")}>
        ...
        {analysis && (
          <ReactMarkdown
            className="mt-4 w-full p-2 border rounded text-neutrals-700 space-y-4"
            components={{
              h1: ({ node, ...props }) => <h1 className="text-h3 font-bold" {...props} />,
              h2: ({ node, ...props }) => <h2 className="text-h4 font-bold" {...props} />,
              h3: ({ node, ...props }) => <h3 className="text-h5 font-bold" {...props} />,
              p: ({ node, ...props }) => <p className="text-body" {...props} />, 
              li: ({ node, ...props }) => <li className="ml-4 list-disc text-body" {...props} />,
            }}
          >
            {analysis}
          </ReactMarkdown>
