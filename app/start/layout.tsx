  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 min-w-0">
        {/* Top white banner with optional Back (logout stays in sidebar) */}
        <div className="sticky top-0 z-40 backdrop-blur bg-neutrals-0/70 border-b border-accent-700 h-12 flex items-center">
          <div className="px-4">
            {showBack && (
              <button
                type="button"
